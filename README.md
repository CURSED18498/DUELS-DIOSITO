...
local function showDiscordInProgressBar()
	...
	progressPct.Text = "diosito on top"
...
for _, name in pairs({"DiositoDuelsGUI"}) do
...
local _C={
	[1]=Color3.fromRGB(8, 0, 0),   [2]=Color3.fromRGB(12, 0, 0),
	[3]=Color3.fromRGB(24, 4, 4),[4]=Color3.fromRGB(45, 6, 6),
	[5]=Color3.fromRGB(120, 10, 10),[6]=Color3.fromRGB(180, 20, 20),
	[7]=Color3.fromRGB(255, 235, 235),[8]=Color3.fromRGB(190, 90, 90),
	[9]=Color3.fromRGB(70, 8, 8),[10]=Color3.fromRGB(18, 2, 2),
}
...
local mainStroke = Instance.new("UIStrok
